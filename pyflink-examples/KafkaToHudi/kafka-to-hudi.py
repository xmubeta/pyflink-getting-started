...
This module:                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            
    ...
    2. Creates a source table from a Kafka
    3. Creates a sink table writing to an S3 Bucket with Hudi format
    4. Queries from the Source Table and the results are inserted into the Sink table (S3)
"""
...
if is_local:
    ...
    table_env.get_config().get_configuration().set_string(
        ...
        "file:///"
        + CURRENT_DIR
        + "/lib/FatJar-Kafka-Hudi-0.14-1.0-SNAPSHOT-combined.jar"
    )
...
def main():
    ...
    # 4. These recordss are inserted into the sink table (S3)
